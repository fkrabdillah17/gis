<!-- Main modal -->
<div id="provinceCreate" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
            ...
            <form method="POST" action="{{ route('admin.province.store') }}">
                ...
                <div class="flex items-start justify-between rounded-t border-b p-4 dark:border-gray-600">
                    ...
                    <button type="button"
                        ...
                        data-modal-hide="provinceCreate">
                ...
                <div class="space-y-6 p-6">
                    <div class="group relative z-0 mb-6 w-full">
                        <input type="text" name="province" id="province"
                            ...
                            placeholder=" " value="{{ old('province') }}" required />
                        <label for="province"
                ...
                <div class="flex items-center justify-between space-x-2 rounded-b border-t border-gray-200 p-6 dark:border-gray-600">
                    <button data-modal-hide="provinceCreate" type="button"
